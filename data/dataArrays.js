export const ventilators = [
  {
    ...
    name: 'LTV 1200',
    photo_url:
    'https://img1.quadmed.com/prodimage/ProductImage/800/28c36dff-997f-4fc5-9a60-75284f0eed3a.jpg'
  },
  {
    id: 1,
    name: 'Servo-U',
    photo_url: 'https://www.getinge.com/siteassets/products-a-z/servo-u-mechanical-ventilator/int-2019-06-12/servo-u-apart-1140-740.jpg'
  },
  {
    id: 2,
    name: 'Hamilton G-5',
    photo_url:
      'https://cardomedical.com/wp-content/uploads/2020/03/Hamilton-G5.jpg'
  },
  {
    id: 4,
    name: 'Puritan Bennett 840',
    photo_url:
    'https://storage.googleapis.com/avante/images/1236-1-puritan-bennett-840.jpg'
  }
];
...
export const sections = [
  {
    sectionId: 1,
    title: 'Disease Agent',
    description: 'Virus is called SARS-CoV-2 and is an enveloped RNA coronavirus. Similar to SARS-CoV-1 from 2003.',
    references: ['N/A'],
  },
  {
    sectionId: 2,
    title: 'Transmission',
    description: 'Initially wildlife (bats and pangolins) → human. Now human→ human. Infectious secretions: resp droplets, sputum, blood, serum. Attaches to Angiotensin Converting Enzyme-2 (ACE-2) receptor of type II pneumocytes.',
    references: ['https://www.cdc.gov/coronavirus/2019-ncov/hcp/caring-for-patients.html']
  }
