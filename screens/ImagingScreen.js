...
export default class ImagingScreen extends Component {
  ...
  render() {
    return (
        <View style = {styles.container}>
          <ScrollView>
            <Text style={styles.titleText}> Imaging</Text>
            <Text style={styles.subtitleText} data={this.state.data.Imaging}></Text>
          </ScrollView>
        </View>
  );
}
