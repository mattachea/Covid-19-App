  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Accordion title="Overall" data="ALWAYS wear PPE and PAPR or N95 + Face Shield Clustered care. Be proactive regarding procedures" ></Accordion>
...
Steroids can be considered for other indications (e.g.: COPD exacerbation)" ></Accordion>
...
Consider CVVH. If unavailable, can use iHD w low dose vasopressors." ></Accordion>
...
Permissive hypercapnia pH > 7.2" ></Accordion>
...
● CO2 colorimetric detector, high efficiency hydrophobic filter" ></Accordion>
...
Inotropic support may be considered" ></Accordion>
...
remission of respiratory symptoms, and two throat-swab samples negative for SARS-CoV-2 RNA obtained at least 24 h apart.[2]" ></Accordion>
        </ScrollView>
       </View>
    )
  }
