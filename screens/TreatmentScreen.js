  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Accordion title="Overall" data="ALWAYS wear PPE and PAPR or N95 + Face Shield Clustered care. Be proactive regarding procedures" colorRow = "#7ED551" colorChild = "#bcf2a0"></Accordion>
...
Steroids can be considered for other indications (e.g.: COPD exacerbation)" colorRow = "#7ED551" colorChild = "#bcf2a0"></Accordion>
...
Consider CVVH. If unavailable, can use iHD w low dose vasopressors." colorRow = "#7ED551" colorChild = "#bcf2a0"></Accordion>
...
Permissive hypercapnia pH > 7.2" colorRow = "#7ED551" colorChild = "#bcf2a0"></Accordion>
...
● CO2 colorimetric detector, high efficiency hydrophobic filter" colorRow = "#7ED551" colorChild = "#bcf2a0"></Accordion>
...
Inotropic support may be considered" colorRow = "#7ED551" colorChild = "#bcf2a0"></Accordion>
...
remission of respiratory symptoms, and two throat-swab samples negative for SARS-CoV-2 RNA obtained at least 24 h apart.[2]" colorRow = "#7ED551" colorChild = "#bcf2a0"></Accordion>
        </ScrollView>
       </View>
    )
  }
